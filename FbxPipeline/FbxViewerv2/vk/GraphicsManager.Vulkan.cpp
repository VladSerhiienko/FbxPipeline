...
apemode:: GraphicsManager::PrivateContent::APIVersion::APIVersion(bool bDump)
...
apemode:: GraphicsManager::PrivateContent::PrivateContent()
...
bool apemode:: GraphicsManager::PrivateContent::ScanInstanceLayerProperties()
{
...
bool apemode:: GraphicsManager::PrivateContent::ScanAdapters(
...
apemode:: GraphicsManager::PrivateContent::NativeLayerWrapper &
apemode:: GraphicsManager::PrivateContent::GetUnnamedLayer()
{
...
bool apemode:: GraphicsManager::PrivateContent::InitializeInstance(GraphicsEcosystem & Ecosys)
{
...
apemode::GraphicsManager::PrivateContent::BreakCallback(VkFlags                    msgFlags,
...
VKAPI_ATTR VkBool32 VKAPI_CALL
apemode::GraphicsManager::PrivateContent::DebugCallback(VkFlags                    msgFlags,
                                                                                VkDebugReportObjectTypeEXT objType,
                                                                                uint64_t                   srcObject,
                                                                                size_t                     location,
                                                                                int32_t                    msgCode,
...
bool apemode:: GraphicsManager::PrivateContent::NativeLayerWrapper::IsUnnamedLayer() const
{
    return bIsUnnamed;
}

bool apemode:: GraphicsManager::PrivateContent::NativeLayerWrapper::IsValidInstanceLayer() const
{
    if (IsUnnamedLayer())
    {
...
void apemode:: GraphicsManager::PrivateContent::NativeLayerWrapper::DumpExtensions() const
{
...
apemode::GraphicsManager::GraphicsManager()
...
bool apemode::GraphicsManager::RecreateGraphicsNodes(EFlags Flags)
{
