...
class SceneFb(object):
    ...
    # SceneFb
    def TransformLimitsLength(self):
        o = flatbuffers.number_types.UOffsetTFlags.py_type(self._tab.Offset(12))
        if o != 0:
            return self._tab.VectorLen(o)
        return 0
...
def SceneFbStart(builder): builder.StartObject(20)
def SceneFbAddVersion(builder, version): builder.PrependUint8Slot(0, version, 0)
def SceneFbAddBboxMin(builder, bboxMin): builder.PrependStructSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(bboxMin), 0)
def SceneFbAddBboxMax(builder, bboxMax): builder.PrependStructSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(bboxMax), 0)
def SceneFbAddTransforms(builder, transforms): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(transforms), 0)
def SceneFbStartTransformsVector(builder, numElems): return builder.StartVector(144, numElems, 4)
def SceneFbAddTransformLimits(builder, transformLimits): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(transformLimits), 0)
def SceneFbStartTransformLimitsVector(builder, numElems): return builder.StartVector(92, numElems, 4)
def SceneFbAddNodes(builder, nodes): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(nodes), 0)
def SceneFbStartNodesVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def SceneFbAddMeshes(builder, meshes): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(meshes), 0)
def SceneFbStartMeshesVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def SceneFbAddAnimStacks(builder, animStacks): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(animStacks), 0)
def SceneFbStartAnimStacksVector(builder, numElems): return builder.StartVector(8, numElems, 4)
def SceneFbAddAnimLayers(builder, animLayers): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(animLayers), 0)
def SceneFbStartAnimLayersVector(builder, numElems): return builder.StartVector(16, numElems, 4)
def SceneFbAddAnimCurves(builder, animCurves): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(animCurves), 0)
def SceneFbStartAnimCurvesVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def SceneFbAddMaterials(builder, materials): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(materials), 0)
def SceneFbStartMaterialsVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def SceneFbAddTextures(builder, textures): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(textures), 0)
def SceneFbStartTexturesVector(builder, numElems): return builder.StartVector(72, numElems, 4)
def SceneFbAddCameras(builder, cameras): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(cameras), 0)
def SceneFbStartCamerasVector(builder, numElems): return builder.StartVector(28, numElems, 4)
def SceneFbAddLights(builder, lights): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(lights), 0)
def SceneFbStartLightsVector(builder, numElems): return builder.StartVector(64, numElems, 4)
def SceneFbAddSkins(builder, skins): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(skins), 0)
def SceneFbStartSkinsVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def SceneFbAddFiles(builder, files): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(files), 0)
def SceneFbStartFilesVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def SceneFbAddBoolValues(builder, boolValues): builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(boolValues), 0)
def SceneFbStartBoolValuesVector(builder, numElems): return builder.StartVector(1, numElems, 1)
def SceneFbAddIntValues(builder, intValues): builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(intValues), 0)
def SceneFbStartIntValuesVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def SceneFbAddFloatValues(builder, floatValues): builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(floatValues), 0)
def SceneFbStartFloatValuesVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def SceneFbAddStringValues(builder, stringValues): builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(stringValues), 0)
